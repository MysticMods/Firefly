...
public class ScrollTableScreen extends ContainerScreen<ScrollTableContainer> {

    private ResourceLocation GUI = new ResourceLocation(Firefly.MODID, "textures/container/scroll_table.png");
    public int x;
    public int y;

    public ScrollTableScreen(ScrollTableContainer containerIn, PlayerInventory inventoryIn, ITextComponent titleIn) {
