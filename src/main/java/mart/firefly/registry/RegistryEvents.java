...
@Mod.EventBusSubscriber(modid= Firefly.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class RegistryEvents {
    ...
    public static void onContainerRegistry(final RegistryEvent.Register<ContainerType<?>> event){
        event.getRegistry().register(IForgeContainerType.create((windowId, inv, data) ->{
            ...
            return new FireflyPressContainer(windowId, pos, inv);
        }).setRegistryName(new ResourceLocation(Firefly.MODID, "firefly_press_container")));

        event.getRegistry().register(IForgeContainerType.create((windowId, inv, data) ->{
            BlockPos pos = data.readBlockPos();
            return new ScrollTableContainer(windowId, pos, inv);
